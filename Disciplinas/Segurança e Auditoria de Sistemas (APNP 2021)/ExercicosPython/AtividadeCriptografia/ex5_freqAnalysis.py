...
with open('res/frankenstein.txt') as f:
    texto = f.read()
    print('englishFreqMatchScore: ', englishFreqMatchScore(texto))
    print('getFrequencyOrder: ', getFrequencyOrder(texto))
    print('getLetterCount: ', getLetterCount(texto))
