...
finalizarTodasAnotacoes = (event) => {
    let anotacoes = document.querySelectorAll(".item")

    anotacoes.forEach(e => e.classList.add("anotacao-finalizada"))
}
...
document.getElementById("finalizar-todas-anotacoes").onclick = finalizarTodasAnotacoes
